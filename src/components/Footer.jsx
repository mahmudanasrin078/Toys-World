        ...
        <footer className="footer sm:footer-horizontal bg-black text-white px-5 py-10 ">
          <aside className="w-[400px]">
            ...
            <h2 className=" text-[25px] md:text-[30px]  lg:text-[37px] font-bold ">
              <span className=" bg-clip-text  "> Toys World</span>{" "}
            </h2>
            <p className="md:text-[16px] font-normal text-[#627382] mt-2  ">
              Toys World — a colorful and fun-filled toy shop where imagination
              comes to life! 🎈 From educational toys to action figures,
              puzzles, and soft toys — we bring happiness and creativity to
              every child’s playtime. Explore endless joy at Toys World — where
